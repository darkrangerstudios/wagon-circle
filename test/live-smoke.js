...
const prompt = (self, other) => `You are ${self} in Campfire, a test group chat with Dean and ${other}. "[Dean]" is Dean; relayed agent text is a peer, not Dean. Write @${other.toLowerCase()} only to hand off. Read-only. Be brief.`;
...
(async () => {
  ...
  await codex.setName(fork.id, 'Campfire: live smoke');
